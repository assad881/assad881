...
KX.config = {
  ...
  /* اللغات — العربية الأساس، والإنجليزية لغة الرجوع.
     الأردية والهندية والبنغالية للعمالة في قطاع الإنشاءات. */
  i18n: { default: 'ar', fallback: 'en', dir: 'rtl',
          available: ['ar', 'en', 'ur', 'hi', 'bn'] },

  /* وحدة البيع الافتراضية للمواد الجديدة */
  defaultUnit: 'm3',
  ...
  demo: {
    enabled: true,
    otpCode: '1234',
    banner: 'نسخة تجريبية — قائمة الأسعار حقيقية من مشاريع الواعدة الحديثة ش.م.م، '
          + 'أما العملاء والناقلون والشاحنات والطلبات فبيانات اختبار.'
  },
